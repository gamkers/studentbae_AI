...
from service.token_genrate import generate_verification_token
from service.smptp import send_verification_email
...
def signup():
    ...
    db.put({"key": email, "password": hashed_password,"verified":'False'})
